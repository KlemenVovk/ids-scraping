...
# We should see a new Chrome window open and navigate to the URL.
# Nice, a bit of a delay so we can see what's happening.
from time import sleep
sleep(2)

# Mention CSS selectors (and By.CSS_SELECTOR)
...
# Let's print the first element to see what we're working with.
# print(quotes_divs[0].get_attribute("outerHTML"))
